...
function insertLegacyErrorLog(siteId, serviceId, instanceId, occurredDate) {
    logs.push({
        occurredDate,
        siteId,
        serviceId,
...
function insertLedgerErrorLog(siteId, serviceId, instanceId, occurredDate) {
    logs.push({
        occurredDate,
        siteId,
        serviceId,
...
function insertInternalErrorLog(siteId, serviceId, instanceId, occurredDate) {
    logs.push({
        occurredDate,
        siteId,
        serviceId,
...
function insertApiCallInfoLog(siteId, serviceId, instanceId, occurredDate) {
    logs.push({
        occurredDate,
        siteId,
        serviceId,
...
function insertNewPairwisedidInfoLog(siteId, serviceId, instanceId, occurredDate) {
    logs.push({
        occurredDate,
        siteId,
        serviceId,
...
function insertCredentialIssuanceInfoLog(siteId, serviceId, instanceId, occurredDate) {
    logs.push({
        occurredDate,
        siteId,
        serviceId,
...
function insertCredentialVerificationInfoLog(siteId, serviceId, instanceId, occurredDate) {
    logs.push({
        occurredDate,
        siteId,
        serviceId,
...
function insertCredentialRevocationInfoLog(siteId, serviceId, instanceId, occurredDate) {
    logs.push({
        occurredDate,
        siteId,
        serviceId,
